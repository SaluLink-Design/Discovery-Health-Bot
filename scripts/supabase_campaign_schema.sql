-- SaluLink literacy campaign tables — run in Supabase SQL editor.
-- Enable RLS and allow anonymous inserts only (no reads from client).
...
-- Anonymous campaign inserts (anon key). Adjust for your security model.
